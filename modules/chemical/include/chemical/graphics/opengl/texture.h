...
namespace Chemical {
  ...
  inline uint32_t GL_CreateTexture(const TextureTraits& traits) {
    ...
    glTextureSubImage2D(texture, 0, 0, 0, traits.image.width, traits.image.height, GL_RGBA, GL_UNSIGNED_BYTE,
                        &traits.image.data[0]);
