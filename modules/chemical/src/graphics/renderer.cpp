...
//     }
//     std::optional<DynamicMeshID> Renderer::RegisterDynamicMesh(const StaticMeshTraits &traits,
...
//     }
//
//     Material &Renderer::RegisterMaterial(const Material &material, const ObjectID &id) {
